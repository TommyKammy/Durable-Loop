...
/**
 * Phase 5: Moved from src/codex/codex-prompt.ts.
 *
 * Local review repair context is a provider-neutral data contract
 * used by the prompt builder, turn execution, and post-publication review.
 */
