...
const codexReviewProviderConfig = {
  reviewBotLogins: [CODEX_CONNECTOR_REVIEW_BOT_LOGIN],
  configuredReviewProviders: [
    { kind: "codex" as const, reviewerLogins: [CODEX_CONNECTOR_REVIEW_BOT_LOGIN], signalSource: "review_threads" as const },
  ],
};
...
test("buildPostPublicationCodexVerificationTimelineArtifacts persists scoped thread keys for blocked normal repair turns", () => {
  ...
  const artifacts = buildPostPublicationCodexVerificationTimelineArtifacts({
    config: codexReviewProviderConfig,
